...
pub struct DepartmentListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список отделов
    #[serde(rename = "content")]
    pub content: Vec<models::DepartmentListDtoBase>,
}

impl DepartmentListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::DepartmentListDtoBase>) -> DepartmentListDto {
        DepartmentListDto {
