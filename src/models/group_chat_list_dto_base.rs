...
pub struct GroupChatListDtoBase {
...
impl GroupChatListDtoBase {
    pub fn new(id: String, title: String, users: serde_json::Value, user_role_map: serde_json::Value, role_config_map: serde_json::Value) -> GroupChatListDtoBase {
