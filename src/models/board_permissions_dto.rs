...
pub struct BoardPermissionsDto {
...
impl BoardPermissionsDto {
    pub fn new(edit_title: bool, delete: bool, r#move: bool, show_stickers: bool, edit_stickers: bool, add_column: bool, columns: models::ColumnPermissionsDto, settings: bool) -> BoardPermissionsDto {
        BoardPermissionsDto {
            edit_title,
            delete,
            r#move,
