...
pub struct ChatMessageListDtoBase {
...
impl ChatMessageListDtoBase {
    pub fn new(id: f64, from_user_id: String, text: String, text_html: String, label: String, edit_timestamp: f64, reactions: serde_json::Value) -> ChatMessageListDtoBase {
