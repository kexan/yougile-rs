...
pub struct SprintStickerWithStatesListDtoBase {
    /// ID объекта
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub states: Option<Vec<models::SprintStickerStateDto>>,
}

impl SprintStickerWithStatesListDtoBase {
    pub fn new(id: String, name: String) -> SprintStickerWithStatesListDtoBase {
