...
pub struct ChatMessageListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// История сообщений
    #[serde(rename = "content")]
    pub content: Vec<models::ChatMessageListDtoBase>,
}

impl ChatMessageListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::ChatMessageListDtoBase>) -> ChatMessageListDto {
        ChatMessageListDto {
