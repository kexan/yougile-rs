...
pub struct CreateSprintStickerDto {
    /// Имя стикера
    #[serde(rename = "name")]
    pub name: String,
    /// Состояния стикера.
    #[serde(rename = "states", skip_serializing_if = "Option::is_none")]
    pub states: Option<Vec<models::SprintStickerStateNoIdDto>>,
}

impl CreateSprintStickerDto {
    pub fn new(name: String) -> CreateSprintStickerDto {
