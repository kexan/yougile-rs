...
pub struct ProjectRoleListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список ролей в проекте
    #[serde(rename = "content")]
    pub content: Vec<models::ProjectRoleListDtoBase>,
}

impl ProjectRoleListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::ProjectRoleListDtoBase>) -> ProjectRoleListDto {
        ProjectRoleListDto {
