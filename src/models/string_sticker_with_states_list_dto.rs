...
pub struct StringStickerWithStatesListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список текстовых стикеров компании
    #[serde(rename = "content")]
    pub content: Vec<models::StringStickerWithStatesListDtoBase>,
}

impl StringStickerWithStatesListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::StringStickerWithStatesListDtoBase>) -> StringStickerWithStatesListDto {
