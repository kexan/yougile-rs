...
pub struct StringStickerWithStatesListDtoBase {
    /// ID объекта
    #[serde(rename = "id")]
    pub id: String,
    ...
    pub states: Option<Vec<models::StringStickerStateDto>>,
...
impl StringStickerWithStatesListDtoBase {
    pub fn new(id: String, name: String) -> StringStickerWithStatesListDtoBase {
