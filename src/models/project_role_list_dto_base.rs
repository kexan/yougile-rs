...
pub struct ProjectRoleListDtoBase {
    /// ID объекта
    #[serde(rename = "id")]
    pub id: String,
    /// Название роли
    ...
    pub permissions: Box<models::ProjectPermissionsDto>,
}

impl ProjectRoleListDtoBase {
    pub fn new(id: String, name: String, permissions: models::ProjectPermissionsDto) -> ProjectRoleListDtoBase {
