...
pub struct SprintStickerWithStatesListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список спринтовых стикеров компании
    #[serde(rename = "content")]
    pub content: Vec<models::SprintStickerWithStatesListDtoBase>,
}

impl SprintStickerWithStatesListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::SprintStickerWithStatesListDtoBase>) -> SprintStickerWithStatesListDto {
