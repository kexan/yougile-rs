...
pub struct GroupChatListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список чатов
    #[serde(rename = "content")]
    pub content: Vec<models::GroupChatListDtoBase>,
}

impl GroupChatListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::GroupChatListDtoBase>) -> GroupChatListDto {
        GroupChatListDto {
