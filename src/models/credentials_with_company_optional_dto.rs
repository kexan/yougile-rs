...
pub struct CredentialsWithCompanyOptionalDto {
    /// Логин пользователя
    #[serde(rename = "login")]
    pub login: String,
    /// Пароль пользователя
...
impl CredentialsWithCompanyOptionalDto {
    pub fn new(login: String, password: String) -> CredentialsWithCompanyOptionalDto {
