...
pub struct CreateStringStickerDto {
    /// Имя стикера
    #[serde(rename = "name")]
    pub name: String,
    /// Иконка стикера
    ...
    pub states: Option<Vec<models::StringStickerStateNoIdDto>>,
}

impl CreateStringStickerDto {
    pub fn new(name: String) -> CreateStringStickerDto {
