...
pub struct ProjectPermissionsDto {
    ...
    pub add_board: bool,
    #[serde(rename = "boards")]
    pub boards: Box<models::BoardPermissionsDto>,
    #[serde(rename = "children")]
    pub children: serde_json::Value,
}

impl ProjectPermissionsDto {
    pub fn new(edit_title: bool, delete: bool, add_board: bool, boards: models::BoardPermissionsDto, children: serde_json::Value) -> ProjectPermissionsDto {
