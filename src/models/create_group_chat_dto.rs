...
impl CreateGroupChatDto {
    pub fn new(title: String, users: serde_json::Value, user_role_map: serde_json::Value, role_config_map: serde_json::Value) -> CreateGroupChatDto {
        CreateGroupChatDto {
            title,
            users,
            user_role_map,
