...
pub struct ColumnListDto {
    /// Дополнительная информация о странице
    #[serde(rename = "paging")]
    pub paging: Box<models::PagingMetadata>,
    /// Список колонок
    #[serde(rename = "content")]
    pub content: Vec<models::ColumnListDtoBase>,
}

impl ColumnListDto {
    pub fn new(paging: models::PagingMetadata, content: Vec<models::ColumnListDtoBase>) -> ColumnListDto {
        ColumnListDto {
