...
impl StickersAPI {
    ...
    pub async fn create_sprint_sticker(
        ...
        self.client.create_sprint_sticker(create_sprint_sticker).await.map_err(SDKError::from)
    }
    ...
    pub async fn get_sprint_sticker(
        ...
        self.client.get_sprint_sticker(id).await.map_err(SDKError::from)
    }
    ...
    pub async fn update_sprint_sticker(
        ...
        self.client.update_sprint_sticker(id, update_sprint_sticker).await.map_err(SDKError::from)
    }
    ...
    pub async fn create_sprint_sticker_state(
        ...
        self.client.create_sprint_sticker_state(sticker_id, create_sprint_sticker_state).await.map_err(SDKError::from)
    }
    ...
    pub async fn get_sprint_sticker_state(
        ...
        self.client.get_sprint_sticker_state(sticker_id, sticker_state_id, include_deleted).await.map_err(SDKError::from)
    }
    ...
    pub async fn update_sprint_sticker_state(
        ...
        self.client.update_sprint_sticker_state(sticker_id, sticker_state_id, update_sprint_sticker_state).await.map_err(SDKError::from)
    }
    ...
    pub async fn create_string_sticker(
        ...
        self.client.create_string_sticker(create_string_sticker).await.map_err(SDKError::from)
    }
    ...
    pub async fn get_string_sticker(
        ...
        self.client.get_string_sticker(id).await.map_err(SDKError::from)
    }
    ...
    pub async fn update_string_sticker(
        ...
        self.client.update_string_sticker(id, update_string_sticker).await.map_err(SDKError::from)
    }
    ...
    pub async fn create_string_sticker_state(
        ...
        self.client.create_string_sticker_state(sticker_id, create_string_sticker_state).await.map_err(SDKError::from)
    }
    ...
    pub async fn get_string_sticker_state(
        ...
        self.client.get_string_sticker_state(sticker_id, sticker_state_id, include_deleted).await.map_err(SDKError::from)
    }
    ...
    pub async fn update_string_sticker_state(
        ...
        self.client.update_string_sticker_state(sticker_id, sticker_state_id, update_string_sticker_state).await.map_err(SDKError::from)
    }
}