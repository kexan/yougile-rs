...
**timestamp** | **f64** | Время создания задачи | 
...
**archived_timestamp** | Option<**f64**> | Время, когда задача перенесена в архив | [optional]
**completed** | Option<**bool**> | Задача выполнена - да/нет | [optional]
**completed_timestamp** | Option<**f64**> | Время, когда задача выполнена | [optional]
...
**created_by** | Option<**String**> | Id пользователя, который создал задачу | [optional]
...
**stopwatch** | Option<[**models::Stopwatch**](Stopwatch.md)> |  | [optional]
**timer** | Option<[**models::Timer**](Timer.md)> |  | [optional]
